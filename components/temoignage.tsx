    ...
    <section className="w-full bg-blue-800">
      <div className="flex justify-center">
        <div>
          ...
          <div className="text-5xl font-bold text-white text-center my-10">
          ...
          <div className="w-[800px] flex pb-14">
            <div className="text-8xl font-black text-orange-300">{"’’"}</div>
            <div className="text-xl font-light text-white text-center pt-4">
